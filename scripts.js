...
switch(answer){
    ...
    case "b":
    return "if they answered b return Nope. GIT337 is the Intermediate HTML/CSS course."
	
		// if they answered c return "Nope. GIT414 is the Responsive HTML/CSS course."
    case "c":
    return "if they answered c return Nope. GIT414 is the Responsive HTML/CSS course."
	
		// if they answered d return "You got it! GIT417 is the Introductory JavaScript course."
    case "d":
        return "if they answered d return You got it! GIT417 is the Introductory JavaScript course."
    }
    }
